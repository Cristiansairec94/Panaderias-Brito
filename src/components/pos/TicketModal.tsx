        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 bg-neutral-100">
          ...
          >
            ...
            <div className="text-center pt-2 space-y-2.5 font-sans border-t-2 border-dashed border-black">
              <div className="space-y-2 border-2 border-black rounded-xl p-3 bg-neutral-50">
                <p className="text-xs sm:text-sm font-black text-black uppercase tracking-wider flex items-center justify-center gap-1.5">
                  <span>🎉</span>
                  <span>¿TIENES FIESTA, REUNIÓN O EVENTO?</span>
                  <span>🎂</span>
                </p>
                <p className="text-xs sm:text-[13px] font-extrabold text-black leading-snug px-1">
                ...
                <div className="pt-0.5">
                  <span className="inline-block px-3 py-1.5 bg-white text-black font-black text-[11px] sm:text-xs rounded-lg border-2 border-black uppercase tracking-wide shadow-2xs">
